...
export const personas: Persona[] = [
  ...
  // ============================================================
  {
    ...
    coursesByTerm: [
      ...
      { termLabel: 'Winter Year 2', courses: ['ESS101', 'ART134'] },
      { termLabel: 'Spring Year 2', courses: ['CHEM152', 'DESIGN380'] },
      { termLabel: 'Fall Year 3', courses: ['HCDE302', 'HCDE308', 'HCDE310'] },
      { termLabel: 'Winter Year 3', courses: ['HCDE303', 'HCDE313', 'HCDE315'] },
      { termLabel: 'Spring Year 3', courses: ['HCDE321', 'HCDE322', 'HCDE351'] },
      { termLabel: 'Fall Year 4', courses: ['HCDE492', 'HCDE438', 'HCDE419', 'HCDE497'] },
      { termLabel: 'Winter Year 4', courses: ['HCDE493', 'HCDE411', 'HCDE450'] },
      { termLabel: 'Spring Year 4', courses: ['HCDE410'] },
    ],
  ...
  // ============================================================
  {
    ...
    coursesByTerm: [
      ...
      { termLabel: 'Winter Year 2', courses: ['CSE123', 'ANTH215'] },
      { termLabel: 'Spring Year 2', courses: ['INFO200', 'SOC101'] },
      { termLabel: 'Fall Year 3', courses: ['HCDE302', 'HCDE308', 'HCDE310'] },
      { termLabel: 'Winter Year 3', courses: ['HCDE303', 'HCDE313', 'HCDE315'] },
      { termLabel: 'Spring Year 3', courses: ['HCDE321', 'HCDE322', 'HCDE351'] },
      { termLabel: 'Fall Year 4', courses: ['HCDE492', 'HCDE439', 'HCDE412', 'HCDE499'] },
      { termLabel: 'Winter Year 4', courses: ['HCDE493', 'HCDE417', 'HCDE419'] },
      { termLabel: 'Spring Year 4', courses: ['HCDE411'] },
    ],
  ...
  // ============================================================
  {
    ...
    coursesByTerm: [
      ...
      { termLabel: 'Spring Year 2', courses: ['PHIL115', 'PSYCH101'] },
      { termLabel: 'Fall Year 3', courses: ['HCDE302', 'HCDE308', 'HCDE310'] },
      { termLabel: 'Winter Year 3', courses: ['HCDE303', 'HCDE313', 'HCDE315'] },
      { termLabel: 'Spring Year 3', courses: ['HCDE321', 'HCDE322', 'HCDE351'] },
  ...
  // ============================================================
  {
    ...
    coursesByTerm: [
      ...
      { termLabel: 'Winter Year 2', courses: ['INFO200', 'DRAMA101'] },
      { termLabel: 'Spring Year 2', courses: ['ESS101', 'AAS310'] },
      { termLabel: 'Fall Year 3', courses: ['HCDE302', 'HCDE308', 'HCDE310'] },
      { termLabel: 'Winter Year 3', courses: ['HCDE303', 'HCDE313', 'HCDE315'] },
      { termLabel: 'Spring Year 3', courses: ['HCDE321', 'HCDE322', 'HCDE351'] },
      { termLabel: 'Fall Year 4', courses: ['HCDE492', 'HCDE417', 'HCDE450', 'ENGR321'] },
      { termLabel: 'Winter Year 4', courses: ['HCDE493', 'HCDE411', 'HCDE419'] },
      { termLabel: 'Spring Year 4', courses: ['HCDE438'] },
    ],
  ...
  // ============================================================
  {
    ...
    coursesByTerm: [
      ...
      { termLabel: 'Winter Year 2', courses: ['INFO200', 'HIST215'] },
      { termLabel: 'Spring Year 2', courses: ['INFO310', 'ENGL242'] },
      { termLabel: 'Fall Year 3', courses: ['HCDE302', 'HCDE308', 'HCDE310'] },
      { termLabel: 'Winter Year 3', courses: ['HCDE303', 'HCDE313', 'HCDE315'] },
      { termLabel: 'Spring Year 3', courses: ['HCDE321', 'HCDE322', 'HCDE351'] },
      { termLabel: 'Fall Year 4', courses: ['HCDE492', 'HCDE417', 'HCDE418', 'HCDE499'] },
      { termLabel: 'Winter Year 4', courses: ['HCDE493', 'HCDE439', 'HCDE412'] },
      { termLabel: 'Spring Year 4', courses: ['HCDE410', 'PHIL340'] },
    ],
  ...
  // ============================================================
  {
    ...
    coursesByTerm: [
      ...
      { termLabel: 'Winter Year 2', courses: ['ART134', 'GWSS200'] },
      { termLabel: 'Spring Year 2', courses: ['DXARTS310', 'PSYCH306'] },
      { termLabel: 'Fall Year 3', courses: ['HCDE302', 'HCDE308', 'HCDE310'] },
      { termLabel: 'Winter Year 3', courses: ['HCDE303', 'HCDE313', 'HCDE315'] },
      { termLabel: 'Spring Year 3', courses: ['HCDE321', 'HCDE322', 'HCDE351'] },
      { termLabel: 'Fall Year 4', courses: ['HCDE492', 'HCDE410', 'HCDE412', 'HCDE497'] },
      { termLabel: 'Winter Year 4', courses: ['HCDE493', 'HCDE411', 'HCDE450'] },
      { termLabel: 'Spring Year 4', courses: ['HCDE438', 'MUSIC116'] },
    ],
