  ...
  recommendedSequence: {
    ...
    terms: [
      ...
      // ==================== YEAR 2: ME Prerequisites + Art Electives ====================
      {
        ...
        courses: ['PHYS122', 'MATH207', 'MATH208', 'PSYCH101'],
        locked: [true, true, true, false],
        slotLabels: ['◆ Electromagnetism (Sciences)', '◆ Differential Equations (ME prereq)', '◆ Matrix Algebra (ME prereq)', '🟢 Intro Psychology — SSc gen-ed'],
      },
      {
        termLabel: 'Winter Year 2',
        courses: ['PHYS123', 'AA210', 'ME230', 'ART253'],
        locked: [true, true, true, false],
        slotLabels: ['◆ Waves, Light & Heat (Sciences)', '◆ Statics (ME prereq)', '◆ Kinematics & Dynamics (ME prereq)', '🟢 Intro Ceramics — hands-on making, A&H gen-ed'],
      },
      {
        termLabel: 'Spring Year 2',
        courses: ['MATH209', 'CEE220', 'MSE170'],
        locked: [true, true, true],
        slotLabels: ['◆ Linear Analysis (ME prereq, needs 207+208)', '◆ Mechanics of Materials (ME prereq)', '◆ Intro Materials Science (ME prereq)'],
      },
      ...
      },
      {
        ...
        courses: ['ME331', 'ME333', 'ME354', 'ME373'],
        locked: [true, true, true, true],
        slotLabels: ['Heat Transfer', 'Fluid Mechanics', 'Technical Communication (W)', 'System Dynamics'],
      },
      {
        termLabel: 'Spring Year 3',
        courses: ['ME356', 'ME374', 'DXARTS470'],
        locked: [true, true, false],
        slotLabels: ['Machine Component Design', 'Systems, Measurements & Control', '🟢 Sensing & Control for Digital Arts — bridges ME into art/fabrication'],
      },

      // ==================== YEAR 4: Capstone + ME Electives + Art ====================
      {
        termLabel: 'Fall Year 4',
        courses: ['ME493', 'ME480', 'ME445', 'DXARTS471'],
        locked: [true, false, false, false],
        slotLabels: ['Capstone Design I (W)', '🟢 ME Elective: Computer-Aided Manufacturing', '🟢 ME Elective: Robotics & Controls', '🟢 Mechatronic Art & Fabrication I — kinetic sculpture + electronics'],
      },
      {
        termLabel: 'Winter Year 4',
        courses: ['ME494', 'ME425', 'ME450', 'ART272'],
        locked: [true, false, false, false],
        slotLabels: ['Capstone Design II', '🟢 ME Elective: Bioengineering', '🟢 ME Elective: Instrumentation', '🟢 Intro Sculpture — 3D art with wood, metal, plaster'],
      },
      {
        termLabel: 'Spring Year 4',
        courses: ['ME495', 'ME470', 'DESIGN165'],
        locked: [true, false, false],
        slotLabels: ['Capstone Design III', '🟢 ME Elective: Mechanical Design', '🟢 Intro Industrial Design — product design thinking'],
      },
    ],
  },
  courses: [
