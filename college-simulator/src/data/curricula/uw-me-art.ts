...
export const uwMeArt: Curriculum = {
  ...
  courses: [
    ...
    { id: 'ME230', title: 'Kinematics and Dynamics', description: 'Particle and rigid body kinematics, Newton\'s laws applied to engineering systems.', credits: 4, category: 'gen-ed', interestTags: [], prereqs: ['MATH125', 'PHYS121'], genEdReqs: [] },
    ...
    { id: 'ME331', title: 'Introduction to Heat Transfer', description: 'Conduction, convection, and radiation heat transfer. Steady-state and transient analysis, heat exchangers.', credits: 4, category: 'major-required', interestTags: [], prereqs: ['ME333'], genEdReqs: [] },
    { id: 'ME333', title: 'Introduction to Fluid Mechanics', description: 'Fluid statics and dynamics, viscous flow, boundary layers, pipe flow, and dimensional analysis.', credits: 5, category: 'major-required', interestTags: [], prereqs: ['AMATH301', 'ME323', 'MATH207'], genEdReqs: [] },
    { id: 'ME354', title: 'Technical Communication for ME', description: 'Written and oral communication for mechanical engineers. Technical reports, proposals, and presentations. Fulfills Writing (W) requirement.', credits: 5, category: 'major-required', interestTags: [], prereqs: ['MSE170', 'CEE220'], genEdReqs: ['writing'] },
    { id: 'ME355', title: 'Introduction to Manufacturing Processes', description: 'Casting, forming, machining, welding, and additive manufacturing. Materials processing and design for manufacturability.', credits: 4, category: 'major-required', interestTags: ['design'], prereqs: ['ME354'], genEdReqs: [] },
    { id: 'ME356', title: 'Machine Component Design', description: 'Design and analysis of machine elements: gears, bearings, shafts, springs, and fasteners. Fatigue and failure analysis.', credits: 4, category: 'major-required', interestTags: ['design'], prereqs: ['ME354'], genEdReqs: [] },
    { id: 'ME373', title: 'Introduction to System Dynamics', description: 'Modeling and analysis of dynamic mechanical, electrical, fluid, and thermal systems. Transfer functions and state-space methods.', credits: 5, category: 'major-required', interestTags: [], prereqs: ['MATH207', 'MATH208', 'EE215', 'ME230'], genEdReqs: [] },
    { id: 'ME374', title: 'Systems, Measurements, and Control', description: 'Feedback control systems, sensors, actuators, PID controllers, and data acquisition for mechanical systems.', credits: 5, category: 'major-required', interestTags: [], prereqs: ['AMATH301', 'ME373'], genEdReqs: [] },
    { id: 'ME493', title: 'ME Capstone Design I', description: 'First phase of the capstone design project. Problem definition, concept generation, engineering analysis, and preliminary design. Fulfills Writing (W) requirement.', credits: 3, category: 'major-required', interestTags: ['design'], prereqs: ['ME123', 'ME354'], genEdReqs: ['writing'] },
    ...
    { id: 'ME480', title: 'Computer-Aided Manufacturing', description: 'CAD/CAM integration, CNC programming, toolpath generation, and digital manufacturing workflows.', credits: 4, category: 'elective', interestTags: ['design'], prereqs: ['ME123', 'AMATH301'], genEdReqs: [] },
    ...
    { id: 'ME470', title: 'Advanced Mechanical Design', description: 'Synthesis and optimization of mechanical systems. Creative problem solving, mechanism design, and computational design tools.', credits: 3, category: 'elective', interestTags: ['design'], prereqs: ['ME373'], genEdReqs: [] },
    ...
    { id: 'ME478', title: 'Finite Element Method', description: 'Computational stress analysis using finite element methods. Modeling, meshing, and interpreting results for structural problems.', credits: 4, category: 'elective', interestTags: [], prereqs: ['ME123', 'ME374', 'MATH208'], genEdReqs: [] },
