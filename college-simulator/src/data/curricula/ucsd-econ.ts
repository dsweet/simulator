  ...
  recommendedSequence: {
    ...
    terms: [
      // YEAR 1 — DOC sequence is mandatory for all Marshall students, plus start calc and intro econ
      {
        ...
        courses: ['DOC1', 'MATH10A', 'ECON1'],
        locked: [true, true, true],
        slotLabels: ['Marshall DOC sequence (required)', 'Major req (Calculus I)', 'Major req (Intro Micro)'],
      },
      {
        termLabel: 'Winter Year 1',
        courses: ['DOC2', 'MATH10B', 'ECON3'],
        locked: [true, true, true],
        slotLabels: ['Marshall DOC sequence (required)', 'Major req (Calculus II)', 'Major req (Intro Macro)'],
      },
      {
        termLabel: 'Spring Year 1',
        courses: ['DOC3', 'MATH10C', 'ECON100A'],
        locked: [true, true, true],
        slotLabels: ['Marshall DOC sequence (required)', 'Major req (Calculus III)', 'Major req (Intermed Micro A)'],
      },
      // YEAR 2 — Intermediate micro/macro sequence, start econometrics, fill gen-eds
      {
        termLabel: 'Fall Year 2',
        courses: ['ECON100B', 'ECON120A', 'HILD7A'],
        locked: [true, true, false],
        slotLabels: ['Major req (Intermed Micro B)', 'Major req (Econometrics A)', 'Humanities gen-ed (choose one)'],
      },
      {
        termLabel: 'Winter Year 2',
        courses: ['ECON100C', 'ECON120B', 'PSYC1'],
        locked: [true, true, false],
        slotLabels: ['Major req (Intermed Micro C)', 'Major req (Econometrics B)', 'Disciplinary Breadth (choose one)'],
      },
      {
        termLabel: 'Spring Year 2',
        courses: ['ECON120C', 'ECON109', 'DSGN1'],
        locked: [true, false, false],
        slotLabels: ['Major req (Econometrics C)', 'Econ elective (choose one)', 'Elective (choose one)'],
      },
    ],
  },
  courses: [
    ...
    { id: 'ECON3', title: 'Principles of Macroeconomics', description: 'National income, employment, inflation, monetary and fiscal policy, and international trade.', credits: 4, category: 'major-required', interestTags: [], prereqs: ['ECON1'], genEdReqs: [] },
    { id: 'ECON100A', title: 'Microeconomics A', description: 'Consumer theory: preferences, utility, budget constraints, demand. Mathematical approach to optimization.', credits: 4, category: 'major-required', interestTags: ['game-theory'], prereqs: ['ECON1', 'MATH10C'], genEdReqs: [] },
    ...
    { id: 'ECON120A', title: 'Econometrics A', description: 'Probability, statistics, and simple regression. Applications to economic data.', credits: 4, category: 'major-required', interestTags: [], prereqs: ['ECON1', 'MATH10C'], genEdReqs: [] },
    ...
    { id: 'ECON110A', title: 'Long-Run Macroeconomics', description: 'Long-run economic growth, capital accumulation, productivity, and the determinants of living standards across countries.', credits: 4, category: 'major-elective', interestTags: ['game-theory'], prereqs: ['ECON1', 'ECON3', 'MATH10C'], genEdReqs: [] },
    ...
    { id: 'ECON130', title: 'Public Policy', description: 'Government policy, taxation, public goods, externalities, and social insurance programs.', credits: 4, category: 'major-elective', interestTags: [], prereqs: ['ECON100A'], genEdReqs: [] },
    ...
    { id: 'ECON138', title: 'Economics of Discrimination', description: 'Economic analysis of discrimination by race, gender, and ethnicity. Wage gaps, audit studies, statistical discrimination, and policy responses.', credits: 4, category: 'major-elective', interestTags: ['cultural-studies'], prereqs: ['ECON1'], genEdReqs: [] },
    { id: 'ECON140', title: 'Economics of Health Care Production and Finance', description: 'Economics of health care markets, production functions, insurance, cost containment, and health policy.', credits: 4, category: 'major-elective', interestTags: [], prereqs: ['ECON100B'], genEdReqs: [] },
    ...
    { id: 'ECON150', title: 'Public Economics: Taxation', description: 'Tax incidence, optimal taxation, tax reform, behavioral responses to taxation, and empirical analysis of tax policy.', credits: 4, category: 'major-elective', interestTags: [], prereqs: ['ECON100C'], genEdReqs: [] },
    { id: 'ECON121', title: 'Applied Econometrics and Data Analysis', description: 'Program evaluation methods: regression discontinuity, difference-in-differences, synthetic controls, and policy analysis with real data.', credits: 4, category: 'major-elective', interestTags: [], prereqs: ['ECON120B'], genEdReqs: [] },
    { id: 'ECON122', title: 'Advanced Topics in Econometrics', description: 'Advanced causal inference: matching estimators, bounds, machine learning for causal effects, and replication of published studies.', credits: 4, category: 'major-elective', interestTags: [], prereqs: ['ECON121'], genEdReqs: [] },
    { id: 'ECON101', title: 'International Trade', description: 'Comparative advantage, trade policy, tariffs, trade agreements, and globalization effects.', credits: 4, category: 'major-elective', interestTags: [], prereqs: ['ECON100B'], genEdReqs: [] },
    ...
    { id: 'ECON172A', title: 'Operations Research A', description: 'Linear programming, optimization, and quantitative methods for economic decision-making.', credits: 4, category: 'major-elective', interestTags: [], prereqs: ['ECON100A', 'ECON120A'], genEdReqs: [] },
    { id: 'ECON173A', title: 'Financial Markets', description: 'Asset pricing, portfolio theory, CAPM, options, efficient markets hypothesis, and behavioral finance.', credits: 4, category: 'major-elective', interestTags: ['game-theory'], prereqs: ['ECON100A', 'ECON120B'], genEdReqs: [] },
    { id: 'ECON178', title: 'Machine Learning for Economics and Business', description: 'Machine learning methods applied to economic prediction and causal inference. Regularization, tree-based methods, and deep learning for economic data.', credits: 4, category: 'major-elective', interestTags: [], prereqs: ['ECON120C'], genEdReqs: [] },
    { id: 'ECON175', title: 'International Financial Markets', description: 'Exchange rates, balance of payments, international capital flows, currency crises, and global financial architecture.', credits: 4, category: 'major-elective', interestTags: ['history'], prereqs: ['ECON1', 'ECON3', 'MATH10C'], genEdReqs: [] },
