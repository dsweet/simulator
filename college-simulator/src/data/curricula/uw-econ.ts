...
export const uwEcon: Curriculum = {
  ...
  courses: [
    ...
    // ===================================================================
    { id: 'ECON411', title: 'Introduction to Econometrics (advanced)', description: 'Advanced regression analysis, time series, panel data, and causal inference methods beyond ECON 382.', credits: 5, category: 'major-elective', interestTags: ['economics'], prereqs: ['ECON300'], genEdReqs: [] },
