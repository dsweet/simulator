...
export const uwEcon: Curriculum = {
  ...
  recommendedSequence: {
    ...
    terms: [
      // ==================== YEAR 1 ====================
      {
        ...
        courses: ['MATH124', 'ECON200', 'ENGL111', 'PHIL100'],
        locked: [true, true, true, false],
        slotLabels: ['Calculus I', 'Intro Microeconomics', 'English Comp', 'A&H elective'],
      },
      {
        termLabel: 'Winter Year 1',
        courses: ['MATH125', 'ECON201', 'POL101', 'HIST111'],
        locked: [true, true, false, false],
        slotLabels: ['Calculus II', 'Intro Macroeconomics', 'SSc elective', 'SSc elective'],
      },
      {
        termLabel: 'Spring Year 1',
        courses: ['MATH126', 'STAT220', 'ENGL283', 'PHIL114'],
        locked: [true, true, false, false],
        slotLabels: ['Calculus III', 'Statistics', 'Writing elective', 'A&H elective'],
      },

      // ==================== YEAR 2 ====================
      {
        termLabel: 'Fall Year 2',
        courses: ['ECON301', 'STAT311', 'POL203', 'CLIT240'],
        locked: [true, true, false, false],
        slotLabels: ['Intermediate Micro', 'Stats for Econ', 'SSc elective', 'A&H elective'],
      },
      {
        termLabel: 'Winter Year 2',
        courses: ['ECON302', 'ECON300', 'PHIL200', 'SOC101'],
        locked: [true, false, false, false],
        slotLabels: ['Intermediate Macro', 'ECON elective', 'A&H elective', 'SSc/DIV elective'],
      },
      {
        termLabel: 'Spring Year 2',
        courses: ['ECON411', 'POL220', 'PHIL120', 'AAS101'],
        locked: [true, false, false, false],
        slotLabels: ['Econometrics', 'ECON/elective', 'elective', 'DIV elective'],
      },

      // ==================== YEAR 3 ====================
      {
        termLabel: 'Fall Year 3',
        courses: ['ECON450', 'ECON425', 'POL320', 'ENGL242'],
        locked: [false, false, false, false],
        slotLabels: ['ECON elective', 'ECON elective', 'elective', 'A&H elective'],
      },
      {
        termLabel: 'Winter Year 3',
        courses: ['ECON420', 'ECON484', 'POL340', 'MUSIC116'],
        locked: [false, false, false, false],
        slotLabels: ['ECON elective', 'ECON elective', 'elective', 'A&H elective'],
      },
      {
        termLabel: 'Spring Year 3',
        courses: ['ECON441', 'POL355', 'PHIL340', 'ASTR101'],
        locked: [false, false, false, false],
      ...
      // ==================== YEAR 4 ====================
      {
        ...
        courses: ['ECON460', 'ECON424', 'COM270', 'LING200'],
        locked: [false, false, false, false],
        slotLabels: ['ECON elective', 'ECON elective', 'elective', 'elective'],
      },
      {
        termLabel: 'Winter Year 4',
        courses: ['ECON482', 'SOC221', 'DXARTS200', 'ENGL320'],
        locked: [false, false, false, false],
        slotLabels: ['ECON elective', 'elective', 'elective', 'elective'],
      },
      {
        termLabel: 'Spring Year 4',
        courses: ['ECON400', 'PHIL250', 'ENGL302', 'ENVIR100'],
        locked: [false, false, false, false],
        slotLabels: ['ECON elective', 'elective', 'elective', 'NW elective'],
      },
    ],
  ...
  courses: [
    ...
    { id: 'STAT220', title: 'Principles of Statistical Reasoning', description: 'Statistical literacy, probability, distributions, hypothesis testing, confidence intervals. Recommended for HCDE placement.', credits: 5, category: 'gen-ed', interestTags: [], prereqs: [], genEdReqs: [] },
