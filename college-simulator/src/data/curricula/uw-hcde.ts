...
export const uwHcde: Curriculum = {
  ...
  degreeRequirements: {
    ...
    genEdCategories: [
      ...
      { id: 'diversity', name: 'Diversity (DIV — may overlap)', creditsRequired: 5, satisfiedBy: ['HCDE315', 'AAS101', 'AAS310', 'GWSS200', 'AIS200', 'ANTH215', 'ENGL262', 'SOC225', 'ENVIR361'] },
  ...
  recommendedSequence: {
    ...
    terms: [
      // ==================== YEAR 1: ENGRUD Placement Requirements ====================
      {
        ...
        courses: ['MATH124', 'CHEM142', 'ENGR101', 'PSYCH101'],
        locked: [true, true, true, false],
        slotLabels: ['◆ Calculus I (Placement)', '◆ General Chemistry (Placement)', '◆ E-FIG: ENGR 101 + GEN ST 199 (2cr)', 'Gen-ed elective (choose one)'],
      },
      {
        termLabel: 'Winter Year 1',
        courses: ['MATH125', 'ENGL111', 'AAS101'],
        locked: [true, true, false],
        slotLabels: ['◆ Calculus II (Placement)', '◆ English Composition (Placement)', '🟢 Intro Asian American Studies — DIV + SSc (AP Stats covers stats req)'],
      },
      {
  ...
  courses: [
    ...
    { id: 'STAT311', title: 'Elements of Statistical Methods', description: 'Estimation, hypothesis testing, ANOVA, and simple linear regression. Applied statistics for science and engineering.', credits: 5, category: 'gen-ed', interestTags: [], prereqs: ['MATH124'], genEdReqs: ['statistics', 'addl-math-sci'] },

    // ◆ Sciences
    { id: 'CHEM142', title: 'General Chemistry', description: 'Atomic structure, chemical bonding, stoichiometry, thermodynamics, and equilibrium. Prerequisite: CHEM 110 or placement exam.', credits: 5, category: 'gen-ed', interestTags: ['science'], prereqs: [], genEdReqs: ['sciences'] },
    { id: 'PHYS121', title: 'Mechanics', description: 'Classical mechanics: motion, forces, energy, momentum, and rotational dynamics. Calculus-based physics for engineers.', credits: 5, category: 'gen-ed', interestTags: ['science', 'space'], prereqs: ['MATH124'], genEdReqs: ['sciences'] },

    // ★ Additional Sciences (for placement and science requirement)
    { id: 'CHEM152', title: 'General Chemistry II', description: 'Chemical kinetics, equilibrium, acids and bases, electrochemistry, and thermodynamics.', credits: 5, category: 'gen-ed', interestTags: ['science'], prereqs: ['CHEM142'], genEdReqs: ['sciences', 'addl-math-sci'] },
    ...
    { id: 'PHYS122', title: 'Electromagnetism', description: 'Electric fields, circuits, magnetic fields, electromagnetic waves, and optics.', credits: 5, category: 'gen-ed', interestTags: ['science', 'space'], prereqs: ['MATH125', 'PHYS121'], genEdReqs: ['sciences', 'addl-math-sci'] },
    { id: 'PHYS123', title: 'Waves, Light, and Heat', description: 'Wave phenomena, geometric and physical optics, thermodynamics, and statistical mechanics.', credits: 5, category: 'gen-ed', interestTags: ['science', 'space'], prereqs: ['MATH126', 'PHYS122'], genEdReqs: ['sciences', 'addl-math-sci'] },
    ...
    { id: 'CSE121', title: 'Intro to Computer Programming I', description: 'Introduction to programming concepts, data types, control flow, and functions. Java-based. Satisfies engineering fundamentals + placement.', credits: 4, category: 'gen-ed', interestTags: ['video-games', 'design'], prereqs: [], genEdReqs: ['eng-fundamentals'] },
    ...
    { id: 'CSE163', title: 'Intermediate Data Programming', description: 'Data analysis with Python, pandas, and matplotlib. Working with real-world datasets, data cleaning, and basic machine learning.', credits: 5, category: 'gen-ed', interestTags: ['design'], prereqs: ['CSE121'], genEdReqs: ['eng-fundamentals'] },
    ...
    { id: 'ENGR115', title: 'Introduction to Engineering Design', description: 'Team-based engineering design process. Problem identification, prototyping, testing, and iteration.', credits: 4, category: 'gen-ed', interestTags: ['design'], prereqs: [], genEdReqs: ['eng-fundamentals'] },
    ...
    { id: 'HCDE310', title: 'Interactive Systems Design & Technology', description: 'Design and implementation of interactive systems. Web technologies, prototyping tools, and the relationship between design and technical constraints.', credits: 5, category: 'major-required', interestTags: ['design', 'video-games'], prereqs: ['CSE121'], genEdReqs: [] },
    ...
    { id: 'HCDE316', title: 'Sustainable Design', description: 'Environmental impact of design decisions, lifecycle analysis, circular economy principles, and designing for sustainability.', credits: 5, category: 'major-elective', interestTags: ['design'], prereqs: [], genEdReqs: [] },
    ...
    { id: 'HCDE351', title: 'User Experience Prototyping Techniques', description: 'Rapid prototyping methods from paper to digital. Wireframing, interactive mockups, and prototype testing with users.', credits: 5, category: 'major-required', interestTags: ['design', 'video-games'], prereqs: ['HCDE303'], genEdReqs: [] },
    { id: 'HCDE492', title: 'Capstone Planning', description: 'Planning phase of the senior capstone project. Problem definition, stakeholder analysis, research plan, and team formation.', credits: 2, category: 'major-required', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE308', 'HCDE310', 'HCDE313', 'HCDE315', 'HCDE321', 'HCDE322', 'HCDE351'], genEdReqs: [] },
    ...
    // ===================================================================
    { id: 'HCDE410', title: 'Human Data Interaction', description: 'Data science literacy anchored in human-centered design. Research ethics, data privacy, algorithmic bias, data curation, and social impacts of data science.', credits: 5, category: 'major-elective', interestTags: ['design', 'video-games'], prereqs: ['HCDE303', 'HCDE310'], genEdReqs: [] },
    { id: 'HCDE411', title: 'Information Visualization', description: 'Design and presentation of digital information. Graphics, animation, and sound for presenting complex information to enhance comprehension and analysis.', credits: 5, category: 'major-elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE310'], genEdReqs: [] },
    { id: 'HCDE417', title: 'Usability Research Techniques', description: 'Usability research methods in product development: contextual inquiry, surveys, focus groups, and usability testing.', credits: 5, category: 'major-elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE313'], genEdReqs: [] },
    { id: 'HCDE438', title: 'Web Technologies', description: 'Technical knowledge including design, markup languages, scripting, and data management for web development.', credits: 5, category: 'major-elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE310'], genEdReqs: [] },
    { id: 'HCDE439', title: 'Physical Computing', description: 'Engineering and prototyping interactive systems and environments using digital electronics, micro-controllers, and software tools.', credits: 5, category: 'major-elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE310'], genEdReqs: [] },

    // ===================================================================
    // HCDE SYSTEMS & SOCIETY ELECTIVES (8cr minimum from this list)
    // ===================================================================
    { id: 'HCDE412', title: 'Qualitative Research Methods in HCDE', description: 'Qualitative research methodologies, particularly grounded theory for field research. Develops interviewing and user-experience investigation skills.', credits: 4, category: 'major-elective', interestTags: ['design', 'philosophy'], prereqs: ['HCDE303', 'HCDE313'], genEdReqs: [] },
    { id: 'HCDE418', title: 'Advanced Projects in HCDE', description: 'Team-based investigations of advanced topics culminating in a project response to a design challenge.', credits: 4, category: 'major-elective', interestTags: ['design', 'cultural-studies'], prereqs: ['HCDE303'], genEdReqs: [] },
    { id: 'HCDE419', title: 'Concepts in Human-Computer Interaction', description: 'Social, cognitive, behavioral, and contextual aspects of information systems. Examines HCI design concepts with ethical considerations.', credits: 4, category: 'major-elective', interestTags: ['design', 'cultural-studies'], prereqs: ['HCDE303'], genEdReqs: [] },
    { id: 'HCDE450', title: 'Product Management', description: 'Strategic planning, communication, leadership, management principles, and phases of the product development lifecycle.', credits: 4, category: 'major-elective', interestTags: ['design'], prereqs: ['HCDE303'], genEdReqs: [] },
    { id: 'HCDE485', title: 'Material and Cultural Bias in Algorithmic Systems', description: 'Project-based course examining the merging of data science with arts and design practices. Challenges biased datasets and ML systems.', credits: 4, category: 'major-elective', interestTags: ['design', 'philosophy'], prereqs: [], genEdReqs: [] },
    ...
    // GAME THEORY
    // ===================================================================
    { id: 'ECON300', title: 'Intermediate Microeconomics', description: 'Consumer theory, producer theory, general equilibrium, welfare analysis, and market failure. Mathematical approach to microeconomic analysis.', credits: 5, category: 'elective', interestTags: ['game-theory', 'economics'], prereqs: ['ECON200', 'MATH124'], genEdReqs: [] },
    ...
    { id: 'ECON301', title: 'Intermediate Macroeconomics', description: 'Economic growth, business cycles, monetary and fiscal policy models, and open-economy macroeconomics.', credits: 5, category: 'elective', interestTags: ['economics'], prereqs: ['ECON201', 'ECON300'], genEdReqs: [] },
    ...
    { id: 'ECON400', title: 'Advanced Microeconomics', description: 'General equilibrium, mechanism design, information economics, and advanced game theory.', credits: 5, category: 'elective', interestTags: ['economics', 'game-theory'], prereqs: ['ECON300', 'MATH126'], genEdReqs: [] },
    { id: 'ECON411', title: 'Behavioral Economics', description: 'Cognitive biases, prospect theory, intertemporal choice, social preferences, and nudge policy design. How psychology influences economic behavior.', credits: 5, category: 'elective', interestTags: ['economics', 'game-theory'], prereqs: ['ECON300'], genEdReqs: [] },
    ...
    { id: 'ECON424', title: 'Development Economics', description: 'Poverty, growth, institutions, health, education, and aid effectiveness in developing countries.', credits: 5, category: 'elective', interestTags: ['economics', 'cultural-studies'], prereqs: ['ECON300', 'STAT311'], genEdReqs: [] },
    ...
    { id: 'ECON482', title: 'Health Economics', description: 'Healthcare markets, insurance, moral hazard, physician behavior, and the economics of public health interventions.', credits: 5, category: 'elective', interestTags: ['economics'], prereqs: ['ECON300', 'STAT311'], genEdReqs: [] },
