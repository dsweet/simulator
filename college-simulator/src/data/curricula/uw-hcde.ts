...
export const uwHcde: Curriculum = {
  ...
  courses: [
    ...
    // ===================================================================
    { id: 'HCDE410', title: 'Advanced Interactive Systems', description: 'Advanced topics in interactive system design. Emerging technologies, AI-powered interfaces, and novel interaction paradigms.', credits: 5, category: 'major-required', interestTags: ['design', 'video-games'], prereqs: ['HCDE310'], genEdReqs: [] },
