...
export const upsEcon: Curriculum = {
  ...
  courses: [
    ...
    { id: 'ECON325', title: 'International Finance', description: 'Exchange rates, balance of payments, international capital flows, currency crises, and global financial institutions.', credits: 1, category: 'major-elective', interestTags: [], prereqs: ['ECON273'], genEdReqs: [] },
    { id: 'ECON335', title: 'Public Finance', description: 'Government taxation, expenditure, and debt. Tax incidence, public goods provision, cost-benefit analysis, and fiscal federalism.', credits: 1, category: 'major-elective', interestTags: [], prereqs: ['ECON272'], genEdReqs: [] },
    { id: 'ECON345', title: 'Financial Economics', description: 'Asset pricing, portfolio theory, risk and return, efficient markets hypothesis, and behavioral finance.', credits: 1, category: 'major-elective', interestTags: ['game-theory'], prereqs: ['ECON272', 'MATH160'], genEdReqs: [] },
    { id: 'ECON355', title: 'Development Economics', description: 'Economic growth and poverty in developing countries. Institutions, trade, aid, microfinance, and randomized evaluations.', credits: 1, category: 'major-elective', interestTags: ['cultural-studies'], prereqs: ['ECON272'], genEdReqs: [] },
    { id: 'ECON365', title: 'Econometrics', description: 'Statistical methods for economic data. Multiple regression, instrumental variables, panel data, and causal inference.', credits: 1, category: 'major-elective', interestTags: [], prereqs: ['ECON272', 'MATH160'], genEdReqs: [] },
    { id: 'ECON370', title: 'Economic History', description: 'Long-run economic development from the Industrial Revolution to globalization. Institutions, technology, and demographic change.', credits: 1, category: 'major-elective', interestTags: ['history'], prereqs: ['ECON171'], genEdReqs: [] },
    { id: 'ECON375', title: 'Urban Economics', description: 'Economics of cities and regions. Housing markets, transportation, segregation, gentrification, and local public goods.', credits: 1, category: 'major-elective', interestTags: [], prereqs: ['ECON272'], genEdReqs: [] },
    { id: 'ECON380', title: 'Economics of Inequality', description: 'Income and wealth distribution, intergenerational mobility, discrimination, and policy responses to inequality.', credits: 1, category: 'major-elective', interestTags: [], prereqs: ['ECON272'], genEdReqs: [] },
    { id: 'ECON385', title: 'Money & Banking', description: 'Financial intermediation, central banking, monetary policy transmission, and the role of money in the macroeconomy.', credits: 1, category: 'major-elective', interestTags: [], prereqs: ['ECON273'], genEdReqs: [] },
    { id: 'ECON390', title: 'Law & Economics', description: 'Economic analysis of legal rules and institutions. Property rights, contracts, torts, crime, and regulation.', credits: 1, category: 'major-elective', interestTags: ['game-theory'], prereqs: ['ECON272'], genEdReqs: [] },
    ...
    { id: 'BUS310', title: 'Corporate Finance', description: 'Capital budgeting, valuation, capital structure, and dividend policy. Financial decision-making for managers.', credits: 1, category: 'elective', interestTags: ['game-theory'], prereqs: ['ECON170', 'MATH160'], genEdReqs: [] },
