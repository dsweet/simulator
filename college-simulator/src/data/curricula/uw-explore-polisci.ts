...
export const uwExplorePolisci: Curriculum = {
  ...
  degreeRequirements: {
    ...
    genEdCategories: [
      ...
      { id: 'addl-ah-ssc', name: 'Additional A&H or SSc', creditsRequired: 10, satisfiedBy: ['ART134', 'ENGL242', 'ENGL243', 'ENGL260', 'ENGL283', 'ENGL349', 'DXARTS200', 'MUSIC116', 'DRAMA101', 'CLIT240', 'CLIT250', 'CLIT270', 'PHIL100', 'PHIL114', 'PHIL149', 'PSYCH101', 'SOC101', 'ECON200', 'HIST111', 'HIST112', 'HIST215', 'HIST225', 'AAS101', 'ANTH215', 'INFO200', 'MUSIC120', 'MUSIC162', 'MUSIC185', 'MUSIC280', 'LING200', 'COM270', 'JAPAN325', 'RELIG101', 'CLASS205', 'PHIL200', 'PHIL242', 'ENGL220', 'ENGL230', 'ENGL240', 'ENGL250', 'ENGL336', 'ENGL342', 'CLIT260', 'CLIT265', 'CLIT280', 'CLIT290', 'ECON201', 'SOC221', 'SOC225'] },
  ...
  recommendedSequence: {
    ...
    terms: [
      ...
      },
      {
        ...
        courses: ['POL450', 'PHIL340', 'ENGL349'],
        locked: [false, false, false],
  ...
  courses: [
    ...
    { id: 'ECON300', title: 'Intermediate Microeconomics', description: 'Consumer theory, producer theory, general equilibrium, welfare analysis, and market failure. Mathematical approach to microeconomic analysis.', credits: 5, category: 'elective', interestTags: ['game-theory', 'economics'], prereqs: ['ECON200'], genEdReqs: [] },
    ...
    { id: 'ENGL303', title: 'History of Literary Criticism and Theory', description: 'Literary criticism and theory from Plato through the early twentieth century.', credits: 5, category: 'elective', interestTags: ['literature', 'philosophy'], prereqs: [], genEdReqs: [] },
