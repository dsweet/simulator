...
export const uwHcdeLite: Curriculum = {
  ...
  recommendedSequence: {
    ...
    terms: [
      ...
      },
      {
        ...
        courses: ['HCDE493', 'MUSIC344', 'ASTR101'],
        locked: [true, false, false],
  ...
  courses: [
    ...
    { id: 'ECON301', title: 'Intermediate Macroeconomics', description: 'Economic growth, business cycles, monetary and fiscal policy models, and open-economy macroeconomics.', credits: 5, category: 'elective', interestTags: ['economics', 'game-theory'], prereqs: ['ECON201', 'ECON300'], genEdReqs: [] },
    ...
    { id: 'ECON411', title: 'Behavioral Economics', description: 'Cognitive biases, prospect theory, intertemporal choice, social preferences, and nudge policy design. How psychology influences economic behavior.', credits: 5, category: 'elective', interestTags: ['economics'], prereqs: ['ECON300'], genEdReqs: [] },
