...
export const uwPoliecon: Curriculum = {
  ...
  degreeRequirements: {
    ...
    electiveCredits: 70,
    majorCourses: [
      'ECON200', 'ECON201', 'POL101', 'PHIL100', 'ECON301', 'POL220', 'PHIL114',
    ],
    genEdCategories: [
      ...
      { id: 'social-science', name: 'Social Sciences (SSc)', creditsRequired: 10, satisfiedBy: ['PSYCH101', 'SOC101', 'HIST111', 'HIST112', 'HIST215', 'HIST225', 'AAS101', 'ANTH215', 'INFO200', 'SOC221', 'SOC225'] },
      { id: 'addl-ah-ssc', name: 'Additional A&H or SSc', creditsRequired: 10, satisfiedBy: ['ART134', 'ENGL242', 'ENGL243', 'ENGL260', 'ENGL283', 'ENGL302', 'DXARTS200', 'MUSIC116', 'DRAMA101', 'CLIT240', 'CLIT250', 'CLIT270', 'PHIL100', 'PHIL114', 'PHIL360', 'MUSIC120', 'MUSIC162', 'MUSIC185', 'MUSIC280', 'LING200', 'COM270', 'COM382', 'RELIG101', 'CLASS205', 'PHIL200', 'PHIL344', 'ENGL220', 'ENGL230', 'ENGL240', 'ENGL250', 'ENGL310', 'ENGL320', 'CLIT260', 'CLIT265', 'CLIT280', 'CLIT290', 'PSYCH101', 'SOC101', 'HIST111', 'HIST112', 'HIST215', 'HIST225', 'AAS101', 'ANTH215', 'INFO200', 'SOC221', 'SOC225'] },
      { id: 'diversity', name: 'Diversity (DIV — may overlap)', creditsRequired: 5, satisfiedBy: ['HCDE315', 'AAS101', 'AAS310', 'GWSS200', 'AIS200', 'ANTH215', 'ENGL262', 'SOC225', 'ENVIR310'] },
      { id: 'natural-world', name: 'Natural World (NW)', creditsRequired: 10, satisfiedBy: ['CHEM142', 'PHYS121', 'BIOL180', 'ASTR101', 'ASTR102', 'ASTR150', 'ESS101', 'ESS102', 'ATM101', 'ENVIR100', 'BIOL200', 'BIOL220'] },
      { id: 'quantitative', name: 'Quantitative (QSR)', creditsRequired: 5, satisfiedBy: ['MATH124', 'STAT290', 'QSCI381'] },
    ],
  },
  recommendedSequence: {
    years: 4,
    terms: [
      // ==================== YEAR 1 ====================
      {
        ...
        courses: ['POL101', 'ECON200', 'ENGL111'],
        locked: [true, true, true],
        slotLabels: ['Intro Political Science', 'Intro Microeconomics', 'English Comp'],
      },
      {
        termLabel: 'Winter Year 1',
        courses: ['PHIL100', 'ECON201', 'HIST111'],
        locked: [true, true, false],
        slotLabels: ['Intro Philosophy', 'Intro Macroeconomics', '🟢 World History — SSc gen-ed (AP Stats covers stats)'],
      },
      {
        termLabel: 'Spring Year 1',
        courses: ['PHIL114', 'POL203', 'ENGL283'],
        locked: [true, false, false],
        slotLabels: ['Ethics', 'SSc elective', 'Writing/A&H'],
      },

      // ==================== YEAR 2 ====================
      {
        termLabel: 'Fall Year 2',
        courses: ['ECON301', 'POL220', 'DXARTS200'],
        locked: [true, true, false],
        slotLabels: ['Intermediate Micro', 'Intro Political Economy', 'Design elective'],
      },
      {
        termLabel: 'Winter Year 2',
        courses: ['POL201', 'ECON300', 'INFO200'],
        locked: [false, false, false],
        slotLabels: ['concentration elective', 'ECON elective', 'Design elective'],
      },
      {
        termLabel: 'Spring Year 2',
        courses: ['POL204', 'PHIL240', 'CSE160'],
        locked: [false, false, false],
        slotLabels: ['concentration elective', 'elective', 'Design elective'],
      },

      // ==================== YEAR 3 ====================
      {
        termLabel: 'Fall Year 3',
        courses: ['POL340', 'ECON425', 'DESIGN369'],
        locked: [false, false, false],
        slotLabels: ['concentration elective', 'concentration elective', 'Design elective'],
      },
      {
        termLabel: 'Winter Year 3',
        courses: ['ECON450', 'POL355', 'INFO343'],
        locked: [false, false, false],
        slotLabels: ['concentration elective', 'concentration elective', 'Design elective'],
      },
      {
        termLabel: 'Spring Year 3',
        courses: ['POL320', 'ECON441', 'PHIL344'],
        locked: [false, false, false],
        slotLabels: ['concentration elective', 'concentration elective', 'elective'],
      },

      // ==================== YEAR 4 ====================
      {
        termLabel: 'Fall Year 4',
        courses: ['ECON484', 'POL310', 'DESIGN479'],
        locked: [false, false, false],
        slotLabels: ['concentration elective', 'concentration elective', 'Design elective'],
      },
      {
        termLabel: 'Winter Year 4',
        courses: ['POL370', 'ECON424', 'CLIT290'],
        locked: [false, false, false],
        slotLabels: ['concentration elective', 'concentration elective', 'A&H elective'],
      },
      {
  ...
  courses: [
    // ===================================================================
    // MAJOR REQUIRED — Political Economy Core
    // ===================================================================
    ...
    { id: 'PHIL100', title: 'Introduction to Philosophy', description: 'Fundamental questions about knowledge, reality, ethics, and the good life. Reading classic and contemporary philosophers.', credits: 5, category: 'major-required', interestTags: ['philosophy'], prereqs: [], genEdReqs: ['arts-humanities', 'addl-ah-ssc'] },
    { id: 'ECON301', title: 'Intermediate Macroeconomics', description: 'Economic growth, business cycles, monetary and fiscal policy models, and open-economy macroeconomics.', credits: 5, category: 'major-required', interestTags: ['economics', 'game-theory'], prereqs: ['ECON201', 'ECON300'], genEdReqs: [] },
    ...
    // ===================================================================
    { id: 'ECON300', title: 'Intermediate Microeconomics', description: 'Consumer theory, producer theory, general equilibrium, welfare analysis, and market failure. Mathematical approach to microeconomic analysis.', credits: 5, category: 'major-elective', interestTags: ['game-theory', 'economics'], prereqs: ['ECON200', 'MATH124'], genEdReqs: [] },
    { id: 'ECON302', title: 'Intermediate Macroeconomics', description: 'Economic growth, business cycles, monetary and fiscal policy models, and open-economy macroeconomics.', credits: 5, category: 'major-elective', interestTags: ['economics'], prereqs: ['ECON201', 'MATH124'], genEdReqs: [] },
    ...
    { id: 'ECON411', title: 'Behavioral Economics', description: 'Cognitive biases, prospect theory, intertemporal choice, social preferences, and nudge policy design. How psychology influences economic behavior.', credits: 5, category: 'major-elective', interestTags: ['economics'], prereqs: ['ECON300'], genEdReqs: [] },
    ...
    // === Political Science 2xx/3xx ===
    { id: 'POL201', title: 'American Politics', description: 'Congress, the presidency, courts, parties, elections, public opinion, and political polarization in the United States.', credits: 5, category: 'major-elective', interestTags: ['politics', 'history'], prereqs: ['POL101'], genEdReqs: ['social-science', 'addl-ah-ssc'] },
    { id: 'POL203', title: 'International Relations', description: 'Theories of war and peace, alliances, international institutions, globalization, and human rights.', credits: 5, category: 'major-elective', interestTags: ['politics', 'history'], prereqs: ['POL101'], genEdReqs: ['social-science', 'addl-ah-ssc'] },
    { id: 'POL204', title: 'Comparative Politics', description: 'How political systems differ across countries. Regime types, democratization, and parliamentary vs. presidential systems.', credits: 5, category: 'major-elective', interestTags: ['politics', 'history'], prereqs: ['POL101'], genEdReqs: ['social-science', 'addl-ah-ssc'] },
    ...
    { id: 'POL370', title: 'Quantitative Methods in Political Science', description: 'Survey design, regression, causal inference, and data visualization applied to political questions.', credits: 5, category: 'major-elective', interestTags: ['politics', 'game-theory'], prereqs: ['POL101', 'STAT290'], genEdReqs: [] },

    // === Philosophy beyond 114 ===
    ...
    { id: 'PHIL120', title: 'Introduction to Logic', description: 'Formal and informal logic, valid arguments, fallacies, and truth tables.', credits: 5, category: 'major-elective', interestTags: ['philosophy', 'game-theory'], prereqs: [], genEdReqs: ['arts-humanities', 'addl-ah-ssc'] },
    { id: 'PHIL200', title: 'Political Philosophy', description: 'Justice, rights, liberty, and equality. Hobbes, Locke, Rousseau, Rawls, Nozick, and contemporary debates about the legitimate scope of state power.', credits: 5, category: 'major-elective', interestTags: ['philosophy', 'politics', 'history'], prereqs: ['PHIL100'], genEdReqs: ['arts-humanities', 'addl-ah-ssc'] },
    ...
    { id: 'PHIL240', title: 'Philosophy of Science', description: 'What makes science scientific? Theory change, realism, values in science, and scientific revolutions.', credits: 5, category: 'major-elective', interestTags: ['philosophy', 'space'], prereqs: [], genEdReqs: [] },
    { id: 'PHIL250', title: 'Metaphysics', description: 'Fundamental nature of reality: existence, identity, causation, time, free will, and possible worlds.', credits: 5, category: 'major-elective', interestTags: ['philosophy'], prereqs: ['PHIL100'], genEdReqs: [] },
    { id: 'PHIL300', title: 'Formal Logic', description: 'Predicate logic, natural deduction, completeness, soundness, and an introduction to modal logic.', credits: 5, category: 'major-elective', interestTags: ['philosophy', 'game-theory'], prereqs: ['PHIL120'], genEdReqs: [] },
    { id: 'PHIL320', title: 'Advanced Ethics: Moral Theory', description: 'Consequentialism, contractualism, moral realism, and metaethics. Contemporary debates in normative theory.', credits: 5, category: 'major-elective', interestTags: ['philosophy'], prereqs: ['PHIL114'], genEdReqs: [] },
    { id: 'PHIL340', title: 'Ethics of Technology', description: 'AI ethics, algorithmic bias, privacy, surveillance, and designing ethical technology. Connects directly to HCDE practice.', credits: 5, category: 'major-elective', interestTags: ['philosophy', 'design'], prereqs: ['PHIL100'], genEdReqs: [] },
    { id: 'PHIL344', title: 'Bioethics', description: 'Ethical issues in medicine and biological sciences. Genetic engineering, euthanasia, reproductive rights, and research ethics.', credits: 5, category: 'major-elective', interestTags: ['philosophy', 'science'], prereqs: [], genEdReqs: ['arts-humanities', 'addl-ah-ssc'] },
    { id: 'PHIL360', title: 'Existentialism', description: 'Freedom, authenticity, and meaning. Kierkegaard, Nietzsche, Heidegger, Sartre, de Beauvoir, and Camus.', credits: 5, category: 'major-elective', interestTags: ['philosophy', 'literature'], prereqs: [], genEdReqs: ['arts-humanities', 'addl-ah-ssc'] },

    // === Supporting Major Electives ===
    ...
    { id: 'PSYCH345', title: 'Judgment & Decision Making', description: 'Heuristics, biases, prospect theory, and rational choice. How people make decisions under uncertainty.', credits: 5, category: 'major-elective', interestTags: ['design', 'game-theory'], prereqs: ['PSYCH101'], genEdReqs: [] },
    ...
    { id: 'STAT290', title: 'Basic Statistics (AP Statistics equivalent)', description: 'Introductory probability and statistical methods. Equivalent awarded for AP Statistics score of 4+.', credits: 5, category: 'gen-ed', interestTags: [], prereqs: [], genEdReqs: ['quantitative'] },
    { id: 'QSCI381', title: 'Introduction to Probability & Statistics', description: 'Probability, random variables, hypothesis testing, and regression. Quantitative methods for natural sciences.', credits: 5, category: 'gen-ed', interestTags: ['science'], prereqs: ['MATH124'], genEdReqs: ['quantitative'] },

    // ===================================================================
    // HCDE COURSES (as electives)
    // ===================================================================
    { id: 'HCDE302', title: 'Foundations of HCDE I', description: 'Introduction to human-centered design principles, design thinking frameworks, and the role of technology in human experience. First course in the HCDE core sequence.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: [], genEdReqs: [] },
    { id: 'HCDE303', title: 'Foundations of HCDE II', description: 'Continuation of HCDE 302. Deeper exploration of design methods, systems thinking, and engineering approaches to human-centered problems.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE302'], genEdReqs: [] },
    { id: 'HCDE308', title: 'Visual Communication in HCDE', description: 'Principles of visual design for engineering communication. Typography, layout, color, data visualization, and information graphics.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: [], genEdReqs: [] },
    { id: 'HCDE310', title: 'Interactive Systems Design & Technology', description: 'Design and implementation of interactive systems. Web technologies, prototyping tools, and the relationship between design and technical constraints.', credits: 5, category: 'elective', interestTags: ['design', 'video-games'], prereqs: ['CSE121'], genEdReqs: [] },
    { id: 'HCDE313', title: 'Introduction to User Research', description: 'Qualitative and quantitative user research methods. Interviews, surveys, contextual inquiry, usability testing, and data analysis. Fulfills Writing (W) requirement.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: [], genEdReqs: ['writing'] },
    { id: 'HCDE315', title: 'Inclusive Design', description: 'Designing for diverse populations, accessibility standards, assistive technologies, and universal design principles. Fulfills SSc and DIV requirements.', credits: 5, category: 'elective', interestTags: ['design', 'cultural-studies'], prereqs: [], genEdReqs: ['diversity', 'social-science'] },
    { id: 'HCDE316', title: 'Sustainable Design', description: 'Environmental impact of design decisions, lifecycle analysis, circular economy principles, and designing for sustainability.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: [], genEdReqs: [] },
    { id: 'HCDE321', title: 'Professional Portfolio', description: 'Building a professional design portfolio. Documenting projects, presenting work, and developing a personal design brand.', credits: 2, category: 'elective', interestTags: ['design'], prereqs: [], genEdReqs: [] },
    { id: 'HCDE322', title: 'Organizational Teamwork', description: 'Team dynamics, communication, conflict resolution, and collaborative design processes in engineering contexts.', credits: 2, category: 'elective', interestTags: ['design'], prereqs: [], genEdReqs: [] },
    { id: 'HCDE351', title: 'User Experience Prototyping Techniques', description: 'Rapid prototyping methods from paper to digital. Wireframing, interactive mockups, and prototype testing with users.', credits: 5, category: 'elective', interestTags: ['design', 'video-games'], prereqs: ['HCDE303'], genEdReqs: [] },
    { id: 'HCDE410', title: 'Human Data Interaction', description: 'Data science literacy anchored in human-centered design. Research ethics, data privacy, algorithmic bias, data curation, and social impacts of data science.', credits: 5, category: 'elective', interestTags: ['design', 'video-games'], prereqs: ['HCDE303', 'HCDE310'], genEdReqs: [] },
    { id: 'HCDE411', title: 'Information Visualization', description: 'Design and presentation of digital information. Graphics, animation, and sound for presenting complex information to enhance comprehension and analysis.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE310'], genEdReqs: [] },
    { id: 'HCDE412', title: 'Qualitative Research Methods in HCDE', description: 'Qualitative research methodologies, particularly grounded theory for field research. Develops interviewing and user-experience investigation skills.', credits: 4, category: 'elective', interestTags: ['design', 'philosophy'], prereqs: ['HCDE303', 'HCDE313'], genEdReqs: [] },
    { id: 'HCDE417', title: 'Usability Research Techniques', description: 'Usability research methods in product development: contextual inquiry, surveys, focus groups, and usability testing.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE313'], genEdReqs: [] },
    { id: 'HCDE418', title: 'Advanced Projects in HCDE', description: 'Team-based investigations of advanced topics culminating in a project response to a design challenge.', credits: 4, category: 'elective', interestTags: ['design', 'cultural-studies'], prereqs: ['HCDE303'], genEdReqs: [] },
    { id: 'HCDE419', title: 'Concepts in Human-Computer Interaction', description: 'Social, cognitive, behavioral, and contextual aspects of information systems. Examines HCI design concepts with ethical considerations.', credits: 4, category: 'elective', interestTags: ['design', 'cultural-studies'], prereqs: ['HCDE303'], genEdReqs: [] },
    { id: 'HCDE438', title: 'Web Technologies', description: 'Technical knowledge including design, markup languages, scripting, and data management for web development.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE310'], genEdReqs: [] },
    { id: 'HCDE439', title: 'Physical Computing', description: 'Engineering and prototyping interactive systems and environments using digital electronics, micro-controllers, and software tools.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE310'], genEdReqs: [] },
    { id: 'HCDE450', title: 'Product Management', description: 'Strategic planning, communication, leadership, management principles, and phases of the product development lifecycle.', credits: 4, category: 'elective', interestTags: ['design'], prereqs: ['HCDE303'], genEdReqs: [] },
    { id: 'HCDE485', title: 'Material and Cultural Bias in Algorithmic Systems', description: 'Project-based course examining the merging of data science with arts and design practices. Challenges biased datasets and ML systems.', credits: 4, category: 'elective', interestTags: ['design', 'philosophy'], prereqs: [], genEdReqs: [] },
    { id: 'HCDE492', title: 'Capstone Planning', description: 'Planning phase of the senior capstone project. Problem definition, stakeholder analysis, research plan, and team formation.', credits: 2, category: 'elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE308', 'HCDE310', 'HCDE313', 'HCDE315', 'HCDE321', 'HCDE322', 'HCDE351'], genEdReqs: [] },
    { id: 'HCDE493', title: 'Senior Capstone', description: 'Culminating team capstone project with an industry or community partner. Full design cycle from research through final deliverable and presentation.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE492'], genEdReqs: [] },
    { id: 'HCDE496', title: 'Directed Research in HCDE', description: 'Faculty-mentored research project applying HCDE methods to a real-world problem. Literature review, methodology, and findings.', credits: 2, category: 'elective', interestTags: ['design'], prereqs: [], genEdReqs: [] },
    { id: 'HCDE497', title: 'Study Abroad: HCDE', description: 'International study experience in human-centered design. Cross-cultural design perspectives and global design challenges.', credits: 2, category: 'elective', interestTags: ['design', 'cultural-studies'], prereqs: [], genEdReqs: [] },
    { id: 'HCDE499', title: 'Individual Research', description: 'Independent research project under faculty supervision. Opportunity to pursue a specific HCDE research interest in depth.', credits: 2, category: 'elective', interestTags: ['design'], prereqs: [], genEdReqs: [] },

    // ===================================================================
    // ENGINEERING COURSES (as electives)
    // ===================================================================
    { id: 'ENGR101', title: 'Engineering Orientation (E-FIG)', description: 'Introduction to the College of Engineering. Explore engineering disciplines, meet faculty, and begin building your engineering identity. Taken with GEN ST 199.', credits: 2, category: 'elective', interestTags: [], prereqs: [], genEdReqs: [] },
    { id: 'ENGR115', title: 'Introduction to Engineering Design', description: 'Team-based engineering design process. Problem identification, prototyping, testing, and iteration.', credits: 4, category: 'elective', interestTags: ['design'], prereqs: [], genEdReqs: [] },
    { id: 'ENGR321', title: 'Engineering Internship Education', description: 'Structured reflection on engineering internship experience. Professional development, workplace culture, and applying classroom learning.', credits: 2, category: 'elective', interestTags: [], prereqs: [], genEdReqs: [] },
    { id: 'ENGR490', title: 'Engineering Leadership', description: 'Leadership skills for engineers. Communication, ethics, project management, and leading technical teams.', credits: 2, category: 'elective', interestTags: [], prereqs: [], genEdReqs: [] },
    ...
    // STATISTICS (Advanced)
    // ===================================================================
    { id: 'STAT311', title: 'Elements of Statistical Methods', description: 'Estimation, hypothesis testing, ANOVA, and simple linear regression. Applied statistics for science and engineering.', credits: 5, category: 'elective', interestTags: [], prereqs: ['MATH124'], genEdReqs: [] },
    { id: 'STAT342', title: 'Intro to Probability & Mathematical Statistics', description: 'Probability distributions, random variables, expected values, central limit theorem, and maximum likelihood estimation.', credits: 5, category: 'elective', interestTags: [], prereqs: ['MATH125', 'STAT290'], genEdReqs: [] },
    ...
    // MATHEMATICS
    // ===================================================================
    { id: 'MATH124', title: 'Calculus with Analytic Geometry I', description: 'Limits, derivatives, and integrals of single-variable functions. Applications to science and engineering.', credits: 5, category: 'elective', interestTags: [], prereqs: [], genEdReqs: ['quantitative'] },
    { id: 'MATH125', title: 'Calculus with Analytic Geometry II', description: 'Integration techniques, applications of integrals, sequences and series.', credits: 5, category: 'elective', interestTags: [], prereqs: ['MATH124'], genEdReqs: [] },
    { id: 'MATH126', title: 'Calculus with Analytic Geometry III', description: 'Multivariable calculus: partial derivatives, multiple integrals, vector calculus, and applications to physics and engineering.', credits: 5, category: 'elective', interestTags: [], prereqs: ['MATH125'], genEdReqs: [] },
    ...
    // ===================================================================
    { id: 'AA210', title: 'Engineering Statics', description: 'Forces, moments, equilibrium of rigid bodies. Foundation for structural and mechanical analysis.', credits: 4, category: 'elective', interestTags: ['space'], prereqs: ['MATH124', 'PHYS121'], genEdReqs: [] },
    { id: 'BIOEN215', title: 'Bioengineering Fundamentals', description: 'Introduction to bioengineering principles, biomaterials, and biomedical device design.', credits: 4, category: 'elective', interestTags: ['science'], prereqs: [], genEdReqs: [] },
    { id: 'CEE220', title: 'Introduction to Mechanics of Materials', description: 'Stress, strain, deformation, and failure of engineering materials. Beams, columns, and torsion.', credits: 4, category: 'elective', interestTags: [], prereqs: ['PHYS121'], genEdReqs: [] },
    { id: 'EE215', title: 'Introduction to Electrical Engineering', description: 'Circuit analysis, resistors, capacitors, inductors, and basic electronics.', credits: 4, category: 'elective', interestTags: [], prereqs: ['MATH125', 'PHYS121'], genEdReqs: [] },
    { id: 'ME123', title: 'Visualization and CAD', description: 'Engineering graphics, 3D modeling, and computer-aided design using SolidWorks.', credits: 4, category: 'elective', interestTags: ['design'], prereqs: [], genEdReqs: [] },
    { id: 'ME230', title: 'Kinematics and Dynamics', description: 'Particle and rigid body kinematics, Newton\'s laws applied to engineering systems.', credits: 4, category: 'elective', interestTags: [], prereqs: ['MATH125', 'PHYS121'], genEdReqs: [] },
    { id: 'MSE170', title: 'Introduction to Materials Science', description: 'Atomic structure, crystal structure, defects, phase diagrams, and mechanical properties of materials.', credits: 4, category: 'elective', interestTags: ['science'], prereqs: ['CHEM142'], genEdReqs: [] },
    { id: 'NME220', title: 'Introduction to Nuclear Engineering', description: 'Nuclear physics, reactor design, radiation, and applications of nuclear technology.', credits: 4, category: 'elective', interestTags: ['science', 'space'], prereqs: ['PHYS121'], genEdReqs: [] },
  ],
};
