...
export const uwPoliecon: Curriculum = {
  ...
  courses: [
    ...
    { id: 'ECON411', title: 'Introduction to Econometrics', description: 'Regression analysis, hypothesis testing, instrumental variables, and causal inference with economic data.', credits: 5, category: 'major-elective', interestTags: ['economics'], prereqs: ['ECON300'], genEdReqs: [] },
    ...
    { id: 'HCDE410', title: 'Advanced Interactive Systems', description: 'Advanced topics in interactive system design. Emerging technologies, AI-powered interfaces, and novel interaction paradigms.', credits: 5, category: 'elective', interestTags: ['design', 'video-games'], prereqs: ['HCDE303', 'HCDE310'], genEdReqs: [] },
    { id: 'HCDE411', title: 'Information Architecture & Data', description: 'Organizing and structuring information for complex systems. Taxonomies, metadata, content modeling, and data-driven design.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE310'], genEdReqs: [] },
    { id: 'HCDE412', title: 'Ethics in Design & Engineering', description: 'Ethical frameworks for design decisions. Privacy, consent, algorithmic bias, and the social responsibility of designers and engineers.', credits: 4, category: 'elective', interestTags: ['design', 'philosophy'], prereqs: ['HCDE303', 'HCDE313'], genEdReqs: [] },
    { id: 'HCDE417', title: 'Design & Machine Learning', description: 'Designing with and for AI/ML systems. Explainability, fairness, human-AI interaction patterns, and responsible AI design.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE313'], genEdReqs: [] },
    { id: 'HCDE418', title: 'Design for Social Impact', description: 'Community-engaged design methods. Co-design with underserved populations, participatory action research, and design justice.', credits: 4, category: 'elective', interestTags: ['design', 'cultural-studies'], prereqs: ['HCDE303'], genEdReqs: [] },
    { id: 'HCDE419', title: 'Global Design & Technology', description: 'Cross-cultural design considerations, technology in developing contexts, and designing for global audiences.', credits: 4, category: 'elective', interestTags: ['design', 'cultural-studies'], prereqs: ['HCDE303'], genEdReqs: [] },
    { id: 'HCDE438', title: 'Advanced Prototyping', description: 'Advanced physical and digital prototyping. Arduino, sensors, wearables, and tangible interaction design for engineers.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE310'], genEdReqs: [] },
    { id: 'HCDE439', title: 'Advanced User Research Methods', description: 'Advanced qualitative methods for design research. Diary studies, participatory design, co-design workshops, and ethnographic fieldwork.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE303', 'HCDE310'], genEdReqs: [] },
    { id: 'HCDE450', title: 'Topics in HCDE', description: 'Special topics in human-centered design and engineering. Content varies by quarter and instructor.', credits: 4, category: 'elective', interestTags: ['design'], prereqs: ['HCDE303'], genEdReqs: [] },
    { id: 'HCDE485', title: 'Design & Policy', description: 'How design intersects with public policy. Regulation of technology, accessible design mandates, and advocating for user needs in policy settings.', credits: 4, category: 'elective', interestTags: ['design', 'philosophy'], prereqs: [], genEdReqs: [] },
