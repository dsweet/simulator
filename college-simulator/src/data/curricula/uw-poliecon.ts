...
export const uwPoliecon: Curriculum = {
  ...
  degreeRequirements: {
    ...
    electiveCredits: 70,
    majorCourses: [
      'ECON200', 'ECON201', 'POL101', 'PHIL100', 'ECON301', 'POL220', 'PHIL114', 'STAT220',
    ],
    genEdCategories: [
  ...
  recommendedSequence: {
    ...
    terms: [
      // ==================== YEAR 1 ====================
      {
        ...
        courses: ['POL101', 'ECON200', 'ENGL111', 'AAS101'],
        locked: [true, true, true, false],
        slotLabels: ['Intro Political Science', 'Intro Microeconomics', 'English Comp', 'SSc/DIV elective'],
      },
      {
        termLabel: 'Winter Year 1',
        courses: ['PHIL100', 'ECON201', 'STAT220', 'HIST111'],
        locked: [true, true, true, false],
        slotLabels: ['Intro Philosophy', 'Intro Macroeconomics', 'Statistics', 'SSc elective'],
      },
      {
        termLabel: 'Spring Year 1',
        courses: ['PHIL114', 'POL203', 'ENGL283', 'ASTR101'],
        locked: [true, false, false, false],
        slotLabels: ['Ethics', 'SSc elective', 'Writing/A&H', 'NW elective'],
      },

      // ==================== YEAR 2 ====================
      {
        termLabel: 'Fall Year 2',
        courses: ['ECON301', 'POL220', 'PHIL200', 'DXARTS200'],
        locked: [true, true, false, false],
        slotLabels: ['Intermediate Micro', 'Intro Political Economy', 'A&H elective', 'Design elective'],
      },
      {
        termLabel: 'Winter Year 2',
        courses: ['POL201', 'ECON300', 'PHIL120', 'INFO200'],
        locked: [false, false, false, false],
        slotLabels: ['concentration elective', 'ECON elective', 'A&H elective', 'Design elective'],
      },
      {
        termLabel: 'Spring Year 2',
        courses: ['POL204', 'PHIL240', 'SOC101', 'CSE160'],
        locked: [false, false, false, false],
        slotLabels: ['concentration elective', 'elective', 'SSc elective', 'Design elective'],
      },

      // ==================== YEAR 3 ====================
      {
        termLabel: 'Fall Year 3',
        courses: ['POL340', 'ECON425', 'PHIL300', 'DESIGN360'],
        locked: [false, false, false, false],
        slotLabels: ['concentration elective', 'concentration elective', 'elective', 'Design elective'],
      },
      {
        termLabel: 'Winter Year 3',
        courses: ['ECON450', 'POL355', 'COM270', 'INFO343'],
        locked: [false, false, false, false],
        slotLabels: ['concentration elective', 'concentration elective', 'elective', 'Design elective'],
      },
      {
        termLabel: 'Spring Year 3',
        courses: ['POL320', 'ECON441', 'PHIL344', 'MUSIC116'],
        locked: [false, false, false, false],
        slotLabels: ['concentration elective', 'concentration elective', 'elective', 'A&H elective'],
      },

      // ==================== YEAR 4 ====================
      {
        termLabel: 'Fall Year 4',
        courses: ['ECON484', 'POL310', 'LING200', 'DESIGN380'],
        locked: [false, false, false, false],
        slotLabels: ['concentration elective', 'concentration elective', 'elective', 'Design elective'],
      },
      {
        termLabel: 'Winter Year 4',
        courses: ['POL370', 'ECON424', 'CLIT290', 'PSYCH345'],
        locked: [false, false, false, false],
        slotLabels: ['concentration elective', 'concentration elective', 'A&H elective', 'elective'],
      },
      {
        termLabel: 'Spring Year 4',
        courses: ['ECON420', 'PHIL250', 'SOC225', 'ENVIR310'],
        locked: [false, false, false, false],
        slotLabels: ['concentration elective', 'elective', 'DIV elective', 'DIV elective'],
      },
    ],
  },
  courses: [
    ...
    { id: 'STAT220', title: 'Principles of Statistical Reasoning', description: 'Statistical literacy, probability, distributions, hypothesis testing, confidence intervals. Recommended for HCDE placement.', credits: 5, category: 'major-required', interestTags: [], prereqs: [], genEdReqs: [] },
    ...
    { id: 'ECON411', title: 'Introduction to Econometrics', description: 'Regression analysis, hypothesis testing, instrumental variables, and causal inference with economic data.', credits: 5, category: 'major-elective', interestTags: ['economics'], prereqs: ['ECON301', 'STAT311'], genEdReqs: [] },
    ...
    { id: 'POL370', title: 'Quantitative Methods in Political Science', description: 'Survey design, regression, causal inference, and data visualization applied to political questions.', credits: 5, category: 'major-elective', interestTags: ['politics', 'game-theory'], prereqs: ['POL101', 'STAT220'], genEdReqs: [] },
    ...
    { id: 'HCDE310', title: 'Interactive Systems Design & Technology', description: 'Design and implementation of interactive systems. Web technologies, prototyping tools, and the relationship between design and technical constraints.', credits: 5, category: 'elective', interestTags: ['design', 'video-games'], prereqs: [], genEdReqs: [] },
    ...
    { id: 'HCDE351', title: 'User Experience Prototyping Techniques', description: 'Rapid prototyping methods from paper to digital. Wireframing, interactive mockups, and prototype testing with users.', credits: 5, category: 'elective', interestTags: ['design', 'video-games'], prereqs: [], genEdReqs: [] },
    { id: 'HCDE410', title: 'Advanced Interactive Systems', description: 'Advanced topics in interactive system design. Emerging technologies, AI-powered interfaces, and novel interaction paradigms.', credits: 5, category: 'elective', interestTags: ['design', 'video-games'], prereqs: ['HCDE310'], genEdReqs: [] },
    { id: 'HCDE411', title: 'Information Architecture & Data', description: 'Organizing and structuring information for complex systems. Taxonomies, metadata, content modeling, and data-driven design.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE302'], genEdReqs: [] },
    { id: 'HCDE412', title: 'Ethics in Design & Engineering', description: 'Ethical frameworks for design decisions. Privacy, consent, algorithmic bias, and the social responsibility of designers and engineers.', credits: 4, category: 'elective', interestTags: ['design', 'philosophy'], prereqs: ['HCDE302'], genEdReqs: [] },
    { id: 'HCDE417', title: 'Design & Machine Learning', description: 'Designing with and for AI/ML systems. Explainability, fairness, human-AI interaction patterns, and responsible AI design.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE302'], genEdReqs: [] },
    { id: 'HCDE418', title: 'Design for Social Impact', description: 'Community-engaged design methods. Co-design with underserved populations, participatory action research, and design justice.', credits: 4, category: 'elective', interestTags: ['design', 'cultural-studies'], prereqs: ['HCDE313'], genEdReqs: [] },
    { id: 'HCDE419', title: 'Global Design & Technology', description: 'Cross-cultural design considerations, technology in developing contexts, and designing for global audiences.', credits: 4, category: 'elective', interestTags: ['design', 'cultural-studies'], prereqs: ['HCDE302'], genEdReqs: [] },
    { id: 'HCDE438', title: 'Advanced Prototyping', description: 'Advanced physical and digital prototyping. Arduino, sensors, wearables, and tangible interaction design for engineers.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE351'], genEdReqs: [] },
    { id: 'HCDE439', title: 'Advanced User Research Methods', description: 'Advanced qualitative methods for design research. Diary studies, participatory design, co-design workshops, and ethnographic fieldwork.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['HCDE313'], genEdReqs: [] },
    { id: 'HCDE450', title: 'Topics in HCDE', description: 'Special topics in human-centered design and engineering. Content varies by quarter and instructor.', credits: 4, category: 'elective', interestTags: ['design'], prereqs: ['HCDE302'], genEdReqs: [] },
    { id: 'HCDE485', title: 'Design & Policy', description: 'How design intersects with public policy. Regulation of technology, accessible design mandates, and advocating for user needs in policy settings.', credits: 4, category: 'elective', interestTags: ['design', 'philosophy'], prereqs: ['HCDE302'], genEdReqs: [] },
    { id: 'HCDE492', title: 'Capstone Planning', description: 'Planning phase of the senior capstone project. Problem definition, stakeholder analysis, research plan, and team formation.', credits: 2, category: 'elective', interestTags: ['design'], prereqs: [], genEdReqs: [] },
    ...
    { id: 'STAT342', title: 'Intro to Probability & Mathematical Statistics', description: 'Probability distributions, random variables, expected values, central limit theorem, and maximum likelihood estimation.', credits: 5, category: 'elective', interestTags: [], prereqs: ['MATH125', 'STAT220'], genEdReqs: [] },
    ...
    { id: 'STAT340', title: 'Introduction to Data Science', description: 'End-to-end data science workflow: data wrangling, exploratory analysis, modeling, and communication.', credits: 5, category: 'elective', interestTags: ['design'], prereqs: ['STAT220'], genEdReqs: [] },
