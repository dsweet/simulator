  ...
  recommendedSequence: {
    ...
    terms: [
      ...
      },
      {
        ...
        courses: ['PHIL100', 'ECON201', 'STAT220'],
        locked: [true, true, true],
        slotLabels: ['Intro Philosophy', 'Intro Macroeconomics', 'Statistics'],
      },
      {
      ...
      // ==================== YEAR 3 ====================
      {
        ...
        courses: ['POL340', 'ECON425', 'DESIGN360'],
        locked: [false, false, false],
      ...
      // ==================== YEAR 4 ====================
      {
        ...
        courses: ['ECON484', 'POL310', 'DESIGN380'],
        locked: [false, false, false],
        slotLabels: ['concentration elective', 'concentration elective', 'Design elective'],
      },
      {
