...
export const richmondEcon: Curriculum = {
  ...
  courses: [
    ...
    { id: 'ECON270', title: 'Introductory Econometrics', description: 'Techniques for rigorously testing economic theory. Regression analysis, estimation, functional form, dummy variables, inference, and assumption violations.', credits: 1, category: 'major-required', interestTags: [], prereqs: ['ECON101', 'ECON102', 'MATH119', 'MATH211'], genEdReqs: [] },
    { id: 'ECON271', title: 'Microeconomic Theory', description: 'Theory of price determination in output and input markets. Consumer and firm behavior under various market structures, theories of exchange and distribution.', credits: 1, category: 'major-required', interestTags: ['game-theory'], prereqs: ['ECON101', 'ECON102', 'MATH211'], genEdReqs: [] },
    { id: 'ECON272', title: 'Macroeconomic Theory', description: 'National income determination, monetary and fiscal policy using Keynesian and New Classical models, and neoclassical growth model extensions.', credits: 1, category: 'major-required', interestTags: [], prereqs: ['ECON102', 'ECON271'], genEdReqs: [] },
