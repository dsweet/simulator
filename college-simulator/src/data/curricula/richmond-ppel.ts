...
export const richmondPpel: Curriculum = {
  ...
  courses: [
    ...
    { id: 'PPEL363', title: 'Rational Choice & Political Theory', description: 'Formal models of rational decision-making applied to political and social problems. Game theory, social choice theory, voting paradoxes, and mechanism design.', credits: 1, category: 'major-required', interestTags: ['game-theory', 'philosophy'], prereqs: ['ECON101'], genEdReqs: [] },
    ...
    { id: 'ECON233', title: 'Ethics & Economics', description: 'Moral dimensions of economic life. Markets and morality, distributive justice, corporate responsibility, and the ethics of globalization.', credits: 1, category: 'major-elective', interestTags: ['philosophy', 'game-theory'], prereqs: [], genEdReqs: [] },
    ...
    { id: 'PHIL369', title: 'Economic Justice', description: 'Philosophical theories of distributive justice. Rawls, Nozick, Sen, and debates over inequality, welfare, taxation, and economic rights.', credits: 1, category: 'major-elective', interestTags: ['philosophy', 'game-theory'], prereqs: [], genEdReqs: [] },
    ...
    { id: 'PHIL364', title: 'Philosophy of Law', description: 'What is law? Natural law, legal positivism, legal realism, and critical legal theory. The relationship between law, morality, and justice.', credits: 1, category: 'major-elective', interestTags: ['philosophy'], prereqs: [], genEdReqs: [] },
    ...
    { id: 'ECON270', title: 'Intermediate Microeconomic Theory', description: 'Rigorous treatment of consumer and producer theory, general equilibrium, welfare economics, and game theory.', credits: 1, category: 'major-elective', interestTags: ['game-theory'], prereqs: ['ECON101', 'MATH211'], genEdReqs: [] },
    { id: 'ECON271', title: 'Intermediate Macroeconomic Theory', description: 'Models of aggregate economic activity. Growth theory, business cycles, monetary policy, and open-economy macroeconomics.', credits: 1, category: 'major-elective', interestTags: [], prereqs: ['ECON102', 'MATH211'], genEdReqs: [] },
