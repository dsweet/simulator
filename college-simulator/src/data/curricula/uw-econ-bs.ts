...
export const uwEconBs: Curriculum = {
  schoolId: 'uw-econ-bs',
  program: 'Economics (BS)',
  degreeRequirements: {
    totalCredits: 180,
    majorCredits: 85, // ECON core (25) + math/stats prereqs (35) + 5 ECON electives (25)
    genEdCredits: 35,
    electiveCredits: 60,
    majorCourses: [
      'ECON200', 'ECON201', 'ECON301', 'ECON302', 'ECON411',
      'MATH124', 'MATH125', 'MATH126', 'MATH308', 'MATH394', 'MATH395', 'STAT311',
    ],
    genEdCategories: [
  ...
  recommendedSequence: {
    ...
    terms: [
      ...
      },
      {
        ...
        courses: ['MATH126', 'STAT220', 'ENGL283'],
        locked: [true, true, false],
        slotLabels: ['Calculus III', 'Statistics', 'Writing elective'],
      },

      // ==================== YEAR 2 ====================
      {
        termLabel: 'Fall Year 2',
        courses: ['ECON301', 'MATH308', 'STAT311'],
        locked: [true, true, true],
        slotLabels: ['Intermediate Micro', 'Matrix Algebra', 'Stats for Econ'],
      },
      {
      ...
      },
      {
        ...
        courses: ['ECON411', 'MATH395', 'POL203'],
        locked: [true, true, false],
        slotLabels: ['Econometrics', 'Probability II', 'SSc elective'],
      },

      // ==================== YEAR 3 ====================
      {
        termLabel: 'Fall Year 3',
        courses: ['ECON450', 'ECON300', 'POL320'],
        locked: [false, false, false],
        slotLabels: ['ECON elective', 'ECON elective', 'elective'],
      },
      {
        termLabel: 'Winter Year 3',
        courses: ['ECON420', 'ECON425', 'COM270'],
        locked: [false, false, false],
        slotLabels: ['ECON elective', 'ECON elective', 'A&H elective'],
      },
      {
        termLabel: 'Spring Year 3',
        courses: ['ECON441', 'ECON484', 'HIST215'],
        locked: [false, false, false],
        slotLabels: ['ECON elective', 'ECON elective', 'elective'],
      },
      ...
      },
      {
        ...
        courses: ['ECON400', 'PHIL250', 'ENGL302'],
        locked: [false, false, false],
        slotLabels: ['ECON elective', 'elective', 'elective'],
      },
    ],
  ...
  courses: [
    ...
    { id: 'MATH308', title: 'Matrix Algebra with Applications', description: 'Systems of linear equations, vector spaces, eigenvalues, and applications to data science, graphics, and engineering.', credits: 3, category: 'major-required', interestTags: [], prereqs: ['MATH125'], genEdReqs: [] },
    { id: 'MATH394', title: 'Probability I', description: 'Sample spaces, conditional probability, random variables, distributions, expectation, and the law of large numbers.', credits: 3, category: 'major-required', interestTags: ['game-theory'], prereqs: ['MATH125'], genEdReqs: [] },
    { id: 'MATH395', title: 'Probability II', description: 'Continuation of MATH 394. Joint distributions, moment-generating functions, convergence theorems, and multivariate probability.', credits: 3, category: 'major-required', interestTags: ['game-theory'], prereqs: ['MATH394'], genEdReqs: [] },

    // Statistics
    { id: 'STAT311', title: 'Elements of Statistical Methods', description: 'Estimation, hypothesis testing, ANOVA, and simple linear regression. Applied statistics for science and engineering.', credits: 5, category: 'major-required', interestTags: [], prereqs: ['STAT220'], genEdReqs: [] },
    ...
    { id: 'ECON412', title: 'Advanced Econometrics', description: 'Time series analysis, panel data, maximum likelihood estimation, and advanced causal inference methods.', credits: 5, category: 'major-elective', interestTags: ['economics'], prereqs: ['ECON411', 'MATH308'], genEdReqs: [] },
    ...
    { id: 'MATH307', title: 'Introduction to Differential Equations', description: 'First and second order ODEs, systems of ODEs, Laplace transforms, and applications to science and engineering.', credits: 3, category: 'major-elective', interestTags: [], prereqs: ['MATH125'], genEdReqs: [] },
    ...
    { id: 'STAT342', title: 'Intro to Probability & Mathematical Statistics', description: 'Probability distributions, random variables, expected values, central limit theorem, and maximum likelihood estimation.', credits: 5, category: 'major-elective', interestTags: [], prereqs: ['MATH125', 'STAT220'], genEdReqs: [] },
    ...
    { id: 'STAT220', title: 'Principles of Statistical Reasoning', description: 'Statistical literacy, probability, distributions, hypothesis testing, confidence intervals. Prerequisite for STAT 311.', credits: 5, category: 'gen-ed', interestTags: [], prereqs: [], genEdReqs: [] },
    ...
    { id: 'PHIL115', title: 'Philosophy of Mind', description: 'Consciousness, artificial intelligence, personal identity, and the mind-body problem.', credits: 5, category: 'elective', interestTags: ['philosophy', 'design'], prereqs: [], genEdReqs: ['arts-humanities', 'addl-ah-ssc'] },
    ...
    { id: 'PHIL340', title: 'Ethics of Technology', description: 'AI ethics, algorithmic bias, privacy, surveillance, and designing ethical technology.', credits: 5, category: 'elective', interestTags: ['philosophy', 'design'], prereqs: ['PHIL100'], genEdReqs: [] },
