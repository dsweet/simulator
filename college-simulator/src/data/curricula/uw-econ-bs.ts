...
export const uwEconBs: Curriculum = {
  ...
  courses: [
    ...
    { id: 'ECON411', title: 'Introduction to Econometrics', description: 'Regression analysis, hypothesis testing, instrumental variables, and causal inference with economic data.', credits: 5, category: 'major-required', interestTags: ['economics'], prereqs: ['ECON300'], genEdReqs: [] },
    ...
    { id: 'STAT290', title: 'Principles of Statistical Reasoning', description: 'Statistical literacy, probability, distributions, hypothesis testing, confidence intervals. Prerequisite for STAT 311.', credits: 5, category: 'gen-ed', interestTags: [], prereqs: [], genEdReqs: [] },
