...
export const uwEconBs: Curriculum = {
  ...
  courses: [
    ...
    { id: 'ECON411', title: 'Behavioral Economics', description: 'Cognitive biases, prospect theory, intertemporal choice, social preferences, and nudge policy design. How psychology influences economic behavior.', credits: 5, category: 'major-required', interestTags: ['economics', 'game-theory'], prereqs: ['ECON300'], genEdReqs: [] },
