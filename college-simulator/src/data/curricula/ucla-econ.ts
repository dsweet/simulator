...
export const uclaEcon: Curriculum = {
  ...
  courses: [
    ...
    { id: 'ECON122', title: 'International Finance', description: 'Balance of payments, exchange rate determination, capital movements, exchange controls, and international monetary organization.', credits: 4, category: 'major-elective', interestTags: [], prereqs: ['ECON102'], genEdReqs: [] },
    { id: 'ECON121', title: 'International Trade Theory', description: 'Trade theory, comparative advantage, trade policy, tariffs, trade agreements, and effects on developing economies.', credits: 4, category: 'major-elective', interestTags: [], prereqs: ['ECON101'], genEdReqs: [] },
    ...
    { id: 'HIST8C', title: 'African History Since 1800', description: 'Colonialism, independence movements, apartheid, and contemporary Africa. Politics, culture, and global connections.', credits: 4, category: 'elective', interestTags: ['history'], prereqs: [], genEdReqs: [] },
